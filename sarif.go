...
// generated by "./schematyper -o sarif.go --package sarif sarif-schema-2.1.0.json" -- DO NOT EDIT
...
// Content The kinds of data contained in this object.
type Content string
...
// DeprecatedGUID An array of unique identifies in the form of a GUID by which this report was known in some previous version of the analysis tool.
type DeprecatedGUID string

// DeprecatedID An array of stable, opaque identifiers by which this report was known in some previous version of the analysis tool.
type DeprecatedID string

// DeprecatedName An array of readable identifiers by which this report was known in some previous version of the analysis tool.
...
// EnvironmentVariable The environment variables associated with the analysis tool process, expressed as key/value pairs.
...
// Fingerprint A set of strings each of which individually defines a stable, unique identity for the result.
...
// Hash A dictionary, each of whose keys is the name of a hash function and each of whose values is the hashed value of the artifact produced by the specified hash function.
type Hash string
...
// InvocationArgument An array of strings, containing in order the command line arguments passed to the tool from the operating system.
...
// LocationRelationshipKind A set of distinct strings that categorize the relationship. Well-known kinds include 'includes', 'isIncludedBy' and 'relevant'.
...
// MessageArgument An array of strings to substitute into the message string.
...
// NewlineSequence An ordered list of character sequences that were treated as line breaks when computing region information for the run.
...
// PartialFingerprint A set of strings that contribute to the stable, unique identity of the result.
...
// RedactionToken An array of strings used to replace sensitive information in a redaction-aware property.
...
// ReportingDescriptorRelationshipKind A set of distinct strings that categorize the relationship. Well-known kinds include 'canPrecede', 'canFollow', 'willPrecede', 'willFollow', 'superset', 'subset', 'equal', 'disjoint', 'relevant', and 'incomparable'.
...
// Role The role or roles played by the artifact in the analysis.
type Role string
...
// SarifSchema2 Static Analysis Results Format (SARIF) Version 2.1.0 JSON Schema: a standard format for the output of static analysis tools.
type SarifSchema2 struct {
...
// StackFrameParameter The parameters of the call that is executing.
...
// WebRequestHeader The request headers.
type WebRequestHeader string

// WebRequestParameter The request parameters.
...
// WebResponseHeader The response headers.
type WebResponseHeader string

// WorkItemURI The URIs of the work items associated with this result.
